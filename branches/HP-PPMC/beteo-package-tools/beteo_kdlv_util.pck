  ...
  *
  *        Zweck: Dieses PL/SQL-Package enthält Hilfsfunktionen zum Umgang mit
  ...
  * *************************************************************************
  * 10.03.2003   Torsten Neumann   Initiale Implementierung für Kintana 4.6
  * 07.10.2003   Torsten Neumann   create_pkg_from_req() hinzugefügt
  ...
  */
  ...
  /*
  * Die Funktion add_package() fügt eine Zeile in die Open Interface-Tabelle
  * KDLV_PACKAGES_INT ein.
  *
  * Bei Erfolg gibt die Funktion den String 'SUCCESS' zurück, ansonsten 'FAILURE'.
  *
  */
  ...
  /*
  * Die Funktion add_package_line() fügt eine Zeile in die Open Interface-Tabelle
...
CREATE OR REPLACE PACKAGE BODY "PPMC1"."BETEO_KDLV_UTIL" IS
  ...
  */
  FUNCTION add_package_line(p_package_interface_id IN kdlv_package_lines_int.package_interface_id%TYPE
    ...
    l_seq NUMBER := 1;
  BEGIN
    -- Sequence Nr. für Package Line erhöhen
    g_sql_num := 110;
    SELECT max(seq)
      INTO l_seq
